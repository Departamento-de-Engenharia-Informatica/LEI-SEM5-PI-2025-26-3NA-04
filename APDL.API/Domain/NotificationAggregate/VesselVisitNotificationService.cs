...
namespace APDL.API.Domain.VesselVisitAggregate
{
    public class VesselVisitNotificationService
    {
        ...
        public async Task<List<VesselVisitNotificationDto>> GetAllAsync()
        {
            ...
            return notifications.Select(notification => new VesselVisitNotificationDto
            {
        ...
        public async Task<VesselVisitNotificationDto> UpdateAsync(UpdateVesselVisitNotificationDto dto)
        {
        ...
        public async Task SubmitAsync(Guid id)
        {
            ...
            if (notification == null)
                throw new BusinessRuleValidationException("Notification", $"Notification with ID {id} not found.");
        ...
        {
            var notification = await _repo.GetByIdAsync(new VesselVisitNotificationId(notificationId));
            if (notification == null)
                throw new BusinessRuleValidationException("Notification", $"Notification with ID {notificationId} not found.");
